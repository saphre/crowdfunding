...
<body class="antialiased">
    <div
        ...
        <div class="max-w-12xl mx-auto p-6 lg:p-6">
            ...
            @if(session('donation_creation_error'))
            <div class="text-danger">
                    {!! session('donation_creation_error') !!}
            </div>
                      ...
                      <form action="{{route('donation.store')}}" method="post">
                        ...
                        <div class="mb-3">
                          ...
                          <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="Default select example" id="currency" name="currency_id">
                                @foreach ($currencies as $currency)
                                    @if ( $currency->attributes->is_active )
                          ...
                          <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control" id="title" placeholder="Title Goes Here">
                          </div>
                          <div class="mb-3">
                            <label for="donation_img" class="form-label text-capitalize">provide a link to an image illustrating your donation </label>
                            <input type="text" name="donation_img" class="form-control" id="donation_img" placeholder="Image Link Goes Here">
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <input type="number" name="target_amount" class="form-control" id="target_amount" placeholder="Target Amount">
                          </div>
                          ...
                          <div class="mb-3">
                            <button type="submit" class="btn btn-outline-success">Create Donation</button>
                          </div>
